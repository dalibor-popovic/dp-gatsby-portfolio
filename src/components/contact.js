...
export const Contact = () => {
  return (
    <section className='container mx-auto max-w-4xl px-4 md:flex flex-wrap justify-center gap-8 md:py-16'>
      <div className='md:flex-[0.5]'>
        <h3 className='font-bold text-amber-500'>CONTACT</h3>
        <h2 className='font-bold text-3xl'>Let's Connect!👋</h2>
      </div>
      <div className='md:flex-[0.5] p-6 flex flex-col gap-4'>
            ...
            >
              <div className='dark:bg-white w-full bg-black duration-200 rounded-xl'>
                <div className='bg-white rounded-xl dark:bg-black dark:border-white active:translate-x-0 active:translate-y-0 flex items-center border-black border-2 duration-200 px-4 py-2 -translate-x-1 -translate-y-1 hover:-translate-x-1.5 hover:-translate-y-1.5 w-full'>
                  <div className='dark:text-white mr-4 flex items-center justify-center'>
                  ...
                  <h4 className='dark:text-white duration-200'>
